                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            {{-- <a href="{{ url()->current() }}" class="logo-link">
                                <img class="logo-light logo-img logo-img-lg" src="{{asset('assets/images/logochti.jpg')}}" srcset="./images/logo2x.png 2x" alt="logo">
                                <img class="logo-dark logo-img logo-img-lg" src="{{asset('assets/images/logochti.jpg')}}" srcset="./images/logo-dark2x.png 2x" alt="logo-dark">
                            </a> --}}
                        </div>
                        <style>
                            .alert-container {
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="nk-block-content text-center text-lg-left">
                                        <p class="text-soft">&copy; Malick_Tall {{ date('Y') }} Tous droit reserves</p>
                                    </div>
                                </div>
                            </div>
                        </div>
